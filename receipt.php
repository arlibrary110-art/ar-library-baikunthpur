...
.btn.secondary{background:#e1e6f2;color:#26365b}
...
<div class="receipt">
    <div class="head">
        <img src="assets/ar-library-logo.webp" alt="AR Library logo" style="width:86px;height:86px;object-fit:contain;border-radius:16px">
        <h1>AR LIBRARY</h1>
        <p>Payment Receipt</p>
    </div>
    ...
    <div class="footer">
        ...
        <?php endif; ?>
        <br>
        <?=htmlspecialchars((string)get_setting('library_name','AR LIBRARY'),ENT_QUOTES,'UTF-8')?> — <?=htmlspecialchars((string)get_setting('address','Ward No. 15, Sarkari Hospital ke Samane, Baikunthpur, Rewa, Madhya Pradesh - 486441'),ENT_QUOTES,'UTF-8')?><br>
        <?=htmlspecialchars((string)get_setting('phone',''),ENT_QUOTES,'UTF-8')?>
    </div>

    <div class="signature"><div class="signature-label">Authorized Signature</div><img class="signature-img" src="assets/abhimanyu-signature.png" alt="Authorized signature"></div>
</div>
