...
if ($conn->connect_error) {
    ...
    // Temporary diagnostic: never expose the password.
    die('DB CONNECTION FAILED | host=' . htmlspecialchars($host, ENT_QUOTES, 'UTF-8') .
        ' | port=' . (int)$port .
        ' | database=' . htmlspecialchars($database, ENT_QUOTES, 'UTF-8') .
        ' | user=' . htmlspecialchars($user, ENT_QUOTES, 'UTF-8') .
        ' | mysqli_error=' . htmlspecialchars($conn->connect_error, ENT_QUOTES, 'UTF-8'));
}
