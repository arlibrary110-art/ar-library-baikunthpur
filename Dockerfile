...
# Pin the MongoDB driver to the 1.x line for maximum compatibility with
# the existing PHP application while PHP 8.2 remains the runtime.
RUN set -eux; \
    apt-get update; \
